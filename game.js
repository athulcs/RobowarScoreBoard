function Game (board_cfg, io, writeToLog) {
	...
	io.on('connection', function (socket) {
		...
		// socket to receive signal to reset game
		socket.on('new game',function(teamnames){
				writeToLog('New Game Signal Received');
				console.log('New Game Signal Received');
				GAME.team_home_score = 0;
				GAME.team_away_score = 0;
				GAME.team_home = teamnames.team1;
				GAME.team_away = teamnames.team2;
				io.emit('reset board', GAME);
		});
